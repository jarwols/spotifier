...
export default function starPlot() {
  ...
  function drawInteraction() {
    ...
    properties.forEach(function(d, i) {
      ...
      .domain([0, 1])
      .range([20, 1000]);
      var lValue = yScale(datum[d]);
      var x = lValue * Math.cos(rExtent) + origin[0] + margin.left;
      var y = lValue * Math.sin(rExtent) + origin[1] + margin.top;
